...
export class BannerComponent  implements OnInit {
  ...
  recipesTypes:RecipeTypes[]=[
    ...
    {image:'greek-food.png',title:'Recetas Comida Griega',icon:'greece-icon.png',recipeType:'Grecia'},
    {image:'italian-food.png',title:'Recetas Comida Italiana',icon:'italy-icon.png',recipeType:'italy'},
    {image:'mexican-food.png',title:'Recetas Comida Mejicána',icon:'mexico-icon.png',recipeType:'Mejicana'},
    {image:'japanese-food.png',title:'Recetas Comida Japonesa',icon:'japan-icon.png',recipeType:'Japonesa'},
    {image:'chinese-food.png',title:'Recetas Comida China',icon:'china-icon.png',recipeType:'China'},
    {image:'brit-food.png',title:'Recetas Comida Inglésa',icon:'england-icon.png',recipeType:'Inglaterra'},
    {image:'french-food.png',title:'Recetas Comida Francesa',icon:'france-icon.png',recipeType:'Francia'},
